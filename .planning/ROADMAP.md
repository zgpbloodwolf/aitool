...
Plans:
- [ ] 08-01-PLAN.md — WindowManager + WindowChannelRegistry + createWindow 重构 + 通知路由 + 托盘更新
- [ ] 08-02-PLAN.md — 分支数据模型 (BranchStore/BranchManager) + 分支 IPC 处理器
- [ ] 08-03-PLAN.md — 标签拖拽出窗口 + 多窗口交互 (ChatPanel 拖拽检测 + ghost 窗口 + 频道迁移)
